...
#Clase padre contribuyentes
#Clase hijo dependencia y clase hijo monotributo

class Contribuyente(ABC):
    @abstractmethod #va a calcular el sueldo de un mono y para dependencia
